...
const TextBlock = ({ props }) =>
  <div className="center measure-wide f5 pv3 lh-copy ph2">
    ...
    <p>
      ...
      and practical as well. It is adopted by many countries around the
      world
      and is based on the German DIN metric Standards. The United States
      uses
    ...
    <p>
      ...
      as possible the DIN sizes: proportions are always leading to other
      nice proportions.
    </p>
